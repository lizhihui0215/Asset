...
#ifndef MOCKER_SWIFT_H
#define MOCKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mocker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// The protocol which can be used to send Mocked data back. Use the <code>Mocker</code> to register <code>Mock</code> data
SWIFT_CLASS("_TtC6Mocker18MockingURLProtocol")
@interface MockingURLProtocol : NSURLProtocol
/// Returns Mocked data based on the mocks register in the <code>Mocker</code>. Will end up in an error when no Mock data is found for the request.
- (void)startLoading;
