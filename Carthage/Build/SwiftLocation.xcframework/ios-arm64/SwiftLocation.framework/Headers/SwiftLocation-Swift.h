...
#ifndef SWIFTLOCATION_SWIFT_H
#define SWIFTLOCATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftLocation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtCO13SwiftLocation12Autocomplete5Apple")
...
@interface Apple (SWIFT_EXTENSION(SwiftLocation)) <MKLocalSearchCompleterDelegate>
...
SWIFT_CLASS("_TtC13SwiftLocation21DeviceLocationManager")
@interface DeviceLocationManager : NSObject <CLLocationManagerDelegate>
