...
class AssetTaskListSearchViewController: BaseViewController {
    @IBOutlet var inventoryStatusButton: UIButton!
    @IBOutlet var searchTextField: UITextField!
    var viewModel: AssetTaskListSearchViewModel!
    ...
    @IBAction func searchButtonTapped(_ sender: UIButton) {
        ...
        perform(segue: StoryboardSegue.Service.unwindToAssetTaskListViewControllerFromSearch)
    }
