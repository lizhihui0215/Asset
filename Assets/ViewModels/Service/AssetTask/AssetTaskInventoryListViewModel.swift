...
class AssetTaskInventoryListViewModel: PageableViewModel<AssetTaskInventoryListViewController, DefaultSection<AssetTaskInventory>>, Searchable {
    ...
    var longitude: String { DefaultCoordinateFormatter.format(assetTaskDetail.longitude) }
    var latitude: String { DefaultCoordinateFormatter.format(assetTaskDetail.latitude) }
