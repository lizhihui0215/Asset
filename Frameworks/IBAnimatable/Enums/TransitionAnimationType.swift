...
extension TransitionAnimationType {
    ...
    var reversed: TransitionAnimationType {
        ...
        case .fold(let direction, let folds):
            return .fold(from: direction.opposite, folds: folds)
        case .portal(let direction, let scale):
        ...
        case .systemCameraIris(let state):
...
public extension TransitionAnimationType {
    /**
...
public extension TransitionAnimationType {
     ...
     */
    enum SystemTransitionType: String {
