...
public extension TimingFunctionType {
...
extension TimingFunctionType {
    var cubicTimingParameters: UICubicTimingParameters {
        ...
        default:
            ...
            let (c1, c2) = caType.controlPoints
            let cP1 = CGPoint(x: CGFloat(c1.x), y: CGFloat(c1.y))
            let cP2 = CGPoint(x: CGFloat(c2.x), y: CGFloat(c2.y))
            return UICubicTimingParameters(controlPoint1: cP1, controlPoint2: cP2)
        }
...
public extension CAMediaTimingFunction {
    ...
    @nonobjc static let easeInOut = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeInEaseOut)
    @nonobjc static let `default` = CAMediaTimingFunction(name: CAMediaTimingFunctionName.default)

    // http://easings.net/
    @nonobjc static let easeInSine = CAMediaTimingFunction(controlPoints: 0.47, 0, 0.745, 0.715)
    @nonobjc static let easeOutSine = CAMediaTimingFunction(controlPoints: 0.39, 0.575, 0.565, 1)
    @nonobjc static let easeInOutSine = CAMediaTimingFunction(controlPoints: 0.445, 0.05, 0.55, 0.95)

    @nonobjc static let easeInQuad = CAMediaTimingFunction(controlPoints: 0.55, 0.085, 0.68, 0.53)
    @nonobjc static let easeOutQuad = CAMediaTimingFunction(controlPoints: 0.25, 0.46, 0.45, 0.94)
    @nonobjc static let easeInOutQuad = CAMediaTimingFunction(controlPoints: 0.455, 0.03, 0.515, 0.955)

    @nonobjc static let easeInCubic = CAMediaTimingFunction(controlPoints: 0.55, 0.055, 0.675, 0.19)
    @nonobjc static let easeOutCubic = CAMediaTimingFunction(controlPoints: 0.215, 0.61, 0.355, 1)
    @nonobjc static let easeInOutCubic = CAMediaTimingFunction(controlPoints: 0.645, 0.045, 0.355, 1)

    @nonobjc static let easeInQuart = CAMediaTimingFunction(controlPoints: 0.895, 0.03, 0.685, 0.22)
    @nonobjc static let easeOutQuart = CAMediaTimingFunction(controlPoints: 0.165, 0.84, 0.44, 1)
    @nonobjc static let easeInOutQuart = CAMediaTimingFunction(controlPoints: 0.77, 0, 0.175, 1)

    @nonobjc static let easeInQuint = CAMediaTimingFunction(controlPoints: 0.755, 0.05, 0.855, 0.06)
    @nonobjc static let easeOutQuint = CAMediaTimingFunction(controlPoints: 0.23, 1, 0.32, 1)
    @nonobjc static let easeInOutQuint = CAMediaTimingFunction(controlPoints: 0.86, 0, 0.07, 1)

    @nonobjc static let easeInExpo = CAMediaTimingFunction(controlPoints: 0.95, 0.05, 0.795, 0.035)
    @nonobjc static let easeOutExpo = CAMediaTimingFunction(controlPoints: 0.19, 1, 0.22, 1)
    @nonobjc static let easeInOutExpo = CAMediaTimingFunction(controlPoints: 1, 0, 0, 1)

    @nonobjc static let easeInCirc = CAMediaTimingFunction(controlPoints: 0.6, 0.04, 0.98, 0.335)
    @nonobjc static let easeOutCirc = CAMediaTimingFunction(controlPoints: 0.075, 0.82, 0.165, 1)
    @nonobjc static let easeInOutCirc = CAMediaTimingFunction(controlPoints: 0.785, 0.135, 0.15, 0.86)

    @nonobjc static let easeInBack = CAMediaTimingFunction(controlPoints: 0.6, -0.28, 0.735, 0.045)
    @nonobjc static let easeOutBack = CAMediaTimingFunction(controlPoints: 0.175, 0.885, 0.32, 1.275)
    @nonobjc static let easeInOutBack = CAMediaTimingFunction(controlPoints: 0.68, -0.55, 0.265, 1.55)
}

public extension CAMediaTimingFunction {
    /// Return the control points of the timing function.
    var controlPoints: ((x: Float, y: Float), (x: Float, y: Float)) {
...
internal extension CAAnimation {
    ...
    var timingFunctionType: TimingFunctionType? {
        ...
        set {
            timingFunction = newValue?.caType
        }
    }
}
    ...
    var timingFunctionsType: [TimingFunctionType]? {
        ...
        set {
            if let types = newValue {
                timingFunctions = types.map(\.caType)
            } else {
                timingFunctions = nil
            }
        }
